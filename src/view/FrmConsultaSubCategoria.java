 ...
 */
public class FrmConsultaSubCategoria extends javax.swing.JDialog {
    
    ConectaBanco conn = new ConectaBanco();
    
    private String idSubCategoria, nomeSubCategoria;

    /**
     * Creates new form FrmConsultaCategoria
     */
    public FrmConsultaSubCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTableSubCategoria = new javax.swing.JTable();
        ...
        setTitle("CONSULTA DE SUB-CATEGORIA");
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jTableSubCategoria.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jTableSubCategoria.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableSubCategoriaMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableSubCategoria);
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        if(jComboBoxTipoFiltro.getSelectedItem().equals("Nome")){
            if(jTextFieldCampoFiltro.getText().equals("")){
                JOptionPane.showMessageDialog(rootPane, "Informe uma sub-categoria");
            }else{
                preencherTabelaSubCategoria("select *from tblsubcategoria where nomeSubCategoria = '"+jTextFieldCampoFiltro.getText()+"'");   
            }           
        }else if(jComboBoxTipoFiltro.getSelectedItem().equals("Contem")){
            if(jTextFieldCampoFiltro.getText().equals("")){
                JOptionPane.showMessageDialog(rootPane, "Informe uma sub-categoria");
            }else{
                preencherTabelaSubCategoria("select *from tblsubcategoria where nomeSubCategoria like '%"+jTextFieldCampoFiltro.getText()+"'"); 
            }             
        }else if (jComboBoxTipoFiltro.getSelectedItem().equals("Código")){
            if(jTextFieldCampoFiltro.getText().equals("")){
                JOptionPane.showMessageDialog(rootPane, "Informe o código de uma sub-categoria");
            }else{
                preencherTabelaSubCategoria("select *from tblsubcategoria where idSubCategoria = '"+jTextFieldCampoFiltro.getText()+"'"); 
            }            
        }else if(jComboBoxTipoFiltro.getSelectedItem().equals("Tudo")){
           preencherTabelaSubCategoria("select *from tblsubcategoria"); 
        }
    ...
    private void jTableSubCategoriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableSubCategoriaMouseClicked
        int linha_selecionada = jTableSubCategoria.getSelectedRow();
        setIdSubCategoria(jTableSubCategoria.getValueAt(linha_selecionada, 0).toString());
        setNomeSubCategoria(jTableSubCategoria.getValueAt(linha_selecionada, 1).toString());
                
        String UnidadeID = "" + jTableSubCategoria.getValueAt(jTableSubCategoria.getSelectedRow(), 0);
        jTextFieldCodigoClicado.setText(UnidadeID);
        
        String SiglaUnidade = "" + jTableSubCategoria.getValueAt(jTableSubCategoria.getSelectedRow(), 1);
        jTextFieldCategoriaClicada.setText(SiglaUnidade);
        
        jButtonAdd.setEnabled(true);
    }//GEN-LAST:event_jTableSubCategoriaMouseClicked

    public void preencherTabelaSubCategoria(String sql){
        ArrayList dados = new ArrayList();
        
        String[] Colunas = new String[]{"ID","Sub-Categoria"};
        conn.conexao();
        conn.executaSQL(sql);
        try{
            conn.rs.first();
            do{
                dados.add(new Object[]{ conn.rs.getString("idSubCategoria") ,  conn.rs.getString("nomeSubCategoria")});
                
            }while (conn.rs.next());
        }catch (SQLException ex){
            //JOptionPane.showMessageDialog(null, "Erro ao preencher o ArrayList!\nERRO:" + ex);
         //catch(NumberFormatException erro){
                JOptionPane.showMessageDialog(null, "Sub-categoria não encontrada");
        }
        
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTableSubCategoria.setModel(modelo);
        jTableSubCategoria.getColumnModel().getColumn(0).setPreferredWidth(40);
        jTableSubCategoria.getColumnModel().getColumn(0).setResizable(false);
        jTableSubCategoria.getColumnModel().getColumn(1).setPreferredWidth(300);
        jTableSubCategoria.getColumnModel().getColumn(1).setResizable(false);
        jTableSubCategoria.getTableHeader().setReorderingAllowed(false);
        jTableSubCategoria.setAutoResizeMode(jTableSubCategoria.AUTO_RESIZE_OFF);
        jTableSubCategoria.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaSubCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmConsultaSubCategoria dialog = new FrmConsultaSubCategoria(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTableSubCategoria;
