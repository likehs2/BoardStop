 ...
 */
public class FrmConsultaMarca extends javax.swing.JDialog {
     ...
     */
    public FrmConsultaMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        if(jComboBoxTipoFiltro.getSelectedItem().equals("Nome")){
            if(jTextFieldCampoFiltro.getText().equals("")){
                JOptionPane.showMessageDialog(rootPane, "Informe uma marca");
            }else{
                preencherTabelaMarca("select *from tblmarca where nomeMarca = '"+jTextFieldCampoFiltro.getText()+"'");   
            }           
        }else if(jComboBoxTipoFiltro.getSelectedItem().equals("Contem")){
            if(jTextFieldCampoFiltro.getText().equals("")){
                JOptionPane.showMessageDialog(rootPane, "Informe uma marca");
            }else{
                preencherTabelaMarca("select *from tblmarca where nomeMarca like '%"+jTextFieldCampoFiltro.getText()+"'"); 
            }             
        }else if (jComboBoxTipoFiltro.getSelectedItem().equals("Código")){
            if(jTextFieldCampoFiltro.getText().equals("")){
                JOptionPane.showMessageDialog(rootPane, "Informe o código de uma marca");
            }else{
                preencherTabelaMarca("select *from tblmarca where categoria = '"+jTextFieldCampoFiltro.getText()+"'"); 
            }            
        }else if(jComboBoxTipoFiltro.getSelectedItem().equals("Tudo")){
           preencherTabelaMarca("select *from tblmarca"); 
        }
    ...
    public void preencherTabelaMarca(String sql){
        ...
        String[] Colunas = new String[]{"ID","Marca"};
        conn.conexao();
        conn.executaSQL(sql);
        try{
            conn.rs.first();
            do{
                dados.add(new Object[]{ conn.rs.getString("idMarca") ,  conn.rs.getString("nomeMarca")});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmConsultaMarca dialog = new FrmConsultaMarca(new javax.swing.JFrame(), true);
